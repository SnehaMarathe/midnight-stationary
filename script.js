...
// Disable "Generate QR Code" and "Share My Location" buttons by default
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('generate-qr-code-btn').disabled = true; // Disable QR Code button
...
function generateQRCode() {
    ...
    if (cart.length === 0) {
        ...
        document.getElementById('generate-qr-code-btn').disabled = true;  // Keep QR code button disabled
        return;
    }
    ...
    // Enable the QR Code button after generating
    document.getElementById('generate-qr-code-btn').disabled = false;
